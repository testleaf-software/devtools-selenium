...
import com.github.qeagle.devtools.protocol.events.network.DataReceived;
import com.github.qeagle.devtools.protocol.events.network.EventSourceMessageReceived;
import com.github.qeagle.devtools.protocol.events.network.LoadingFailed;
import com.github.qeagle.devtools.protocol.events.network.LoadingFinished;
import com.github.qeagle.devtools.protocol.events.network.RequestIntercepted;
import com.github.qeagle.devtools.protocol.events.network.RequestServedFromCache;
import com.github.qeagle.devtools.protocol.events.network.RequestWillBeSent;
import com.github.qeagle.devtools.protocol.events.network.RequestWillBeSentExtraInfo;
import com.github.qeagle.devtools.protocol.events.network.ResourceChangedPriority;
import com.github.qeagle.devtools.protocol.events.network.ResponseReceived;
import com.github.qeagle.devtools.protocol.events.network.ResponseReceivedExtraInfo;
import com.github.qeagle.devtools.protocol.events.network.SignedExchangeReceived;
import com.github.qeagle.devtools.protocol.events.network.WebSocketClosed;
import com.github.qeagle.devtools.protocol.events.network.WebSocketCreated;
import com.github.qeagle.devtools.protocol.events.network.WebSocketFrameError;
import com.github.qeagle.devtools.protocol.events.network.WebSocketFrameReceived;
import com.github.qeagle.devtools.protocol.events.network.WebSocketFrameSent;
import com.github.qeagle.devtools.protocol.events.network.WebSocketHandshakeResponseReceived;
import com.github.qeagle.devtools.protocol.events.network.WebSocketWillSendHandshakeRequest;
...
import com.github.qeagle.devtools.protocol.types.network.AuthChallengeResponse;
import com.github.qeagle.devtools.protocol.types.network.ConnectionType;
import com.github.qeagle.devtools.protocol.types.network.Cookie;
import com.github.qeagle.devtools.protocol.types.network.CookieParam;
import com.github.qeagle.devtools.protocol.types.network.CookieSameSite;
import com.github.qeagle.devtools.protocol.types.network.ErrorReason;
import com.github.qeagle.devtools.protocol.types.network.RequestPattern;
import com.github.qeagle.devtools.protocol.types.network.ResponseBody;
import com.github.qeagle.devtools.protocol.types.network.ResponseBodyForInterception;
